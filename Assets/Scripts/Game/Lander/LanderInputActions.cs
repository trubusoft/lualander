...
//     version 1.14.2
//     from Assets/Scripts/Game/Lander/LanderInputActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Game/Lander/LanderInputActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @LanderInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@LanderInputActions()
    {
        UnityEngine.Debug.Assert(!m_Lander.enabled, "This will cause a leak and performance issues, LanderInputActions.Lander.Disable() has not been called.");
    }
    ...
    public struct LanderActions
    {
        ...
        /// </summary>
        public LanderActions(@LanderInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
